...
<div class= "container">
    ...
    <div class="jumbotron">
        <h1 class="display-4">Bienvenido a 9°</h1>
    ...
    <div class="jumbotron">
        ...
        <a class="btn btn-danger btn-lg" href="/9/Biologia_Quimica" role="button">Click aqui</a>
    </div>
    ...
    <div class="jumbotron">
        ...
        <hr class="my-4">
        <p>haz click aqui para ver todas actividades relacionadas con esta materia</p>
        <a class="btn btn-danger btn-lg" href="/9/Sociales_integradas" role="button">Click aqui</a>
    </div>
    ...
    <div class="jumbotron">
        ...
        <hr class="my-4">
        <p>haz click aqui para ver todas actividades relacionadas con esta materia</p>
        <a class="btn btn-danger btn-lg" href="/9/Español" role="button">Click aqui</a>
    </div>
    ...
    <div class="jumbotron">
        ...
        <hr class="my-4">
        <p>haz click aqui para ver todas actividades relacionadas con esta materia</p>
        <a class="btn btn-danger btn-lg" href="/9/Filosofia" role="button">Click aqui</a>
    </div>
