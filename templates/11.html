...
<div class= "container">
    ...
    <div class="jumbotron" >
        <h1 class="display-4">Bienvenido a 11°</h1>
        <p class="lead">Aqui encontraras actividades relacionadas con 11°</p>
    </div>
    ...
    <div class="jumbotron">
        ...
        <a class="btn btn-danger btn-lg" href="/10/Biologia" role="button">Click aqui</a>
    </div>
    ...
    <div class="jumbotron">
        ...
        <hr class="my-4">
        <p>haz click aqui para ver todas actividades relacionadas con esta materia</p>
        <a class="btn btn-danger btn-lg" href="/10/Historia" role="button">Click aqui</a>
    </div>
    ...
    <div class="jumbotron">
        ...
        <hr class="my-4">
        <p>haz click aqui para ver todas actividades relacionadas con esta materia</p>
        <a class="btn btn-danger btn-lg" href="/10/Espanol" role="button">Click aqui</a>
    </div>
    
    <div class="jumbotron">
        <h1 class="display-4">Trigonometria</h1>
        <p class="lead">Aqui encontraras actividades relacionadas con la materia</p>
        <hr class="my-4">
        <p>haz click aqui para ver todas actividades relacionadas con esta materia</p>
        <a class="btn btn-danger btn-lg" href="/10/Trigonometria" role="button">Click aqui</a>
    </div>
    ...
    <div class="jumbotron">
        <h1 class="display-4">Inglés</h1>
        <p class="lead">Aqui encontraras actividades relacionadas con la materia</p>
        <hr class="my-4">
        <p>haz click aqui para ver todas actividades relacionadas con esta materia</p>
        <a class="btn btn-danger btn-lg" href="/10/English" role="button">Click aqui</a>
    </div>
</div>
{% endblock %}